                        ...
                        this.onFiltersRegistered(() => {
                            ...
                            if (!this.hasPresetRange) { // try to find and apply the range give the set of elements.
                                ...
                                this.filterOptions.initialState.lowerBound =
                                    this.filterOptions.initialState.lowerBound === undefined ?
                                        this.filterOptions.min : this.filterOptions.initialState.lowerBound;
                                this.filterOptions.initialState.upperBound =
                                    this.filterOptions.initialState.upperBound === undefined ?
                                        this.filterOptions.max : this.filterOptions.initialState.upperBound;
